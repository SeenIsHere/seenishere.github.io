            ...
            var timeout2 = setTimeout(function() {
                    ...
                    var timeout3 = setTimeout(function() {
                            ...
                            var timeout4 = setTimeout(function() {
                                    centralText.innerHTML = "<p class='allow-shake'>Hoolarious :)</p>"
...
function flipParticleOpacity() {
    ...
    //reloads
    tsParticles.load("tsparticles", window.tsOptions[window.particleType])
}

function changeParticleType() {
    var icon = document.getElementsByClassName('background-options')
        //rotates through our 3 particle types
    if (window.particleType === 0) {
        window.particleType = 1
        icon[1].innerText = 'filter_2'
    } else if (window.particleType === 1) {
        window.particleType = 0
        icon[1].innerText = 'filter_1'
    }
    //reloads
    tsParticles.load("tsparticles", window.tsOptions[window.particleType]);
}